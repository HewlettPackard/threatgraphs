...
public class VIS_BuildGUIGraphRDCATAFile {


	public String buildGUIGraphRDCATAFile(Vertica ver, String date, String hourParam, String minutesParam, boolean disconnect, String methodName, CommonMethods commonMethods, Properties graphProps) {
        ...
        String fileName =newFile.getAbsolutePath() + "/webapps/gui/data/rd" + date.replace("/", "") + "-"+ hourParam + minutesParam;
		...
		if (layout == null) {
         ...
         if (!new File(fileName).isFile()) {
		    ...
		    try { 
				...
				commonMethods.printMessage("QUERY", "*** METHOD buildGUIGraphRDCATAFile: " + query1+filtering);
