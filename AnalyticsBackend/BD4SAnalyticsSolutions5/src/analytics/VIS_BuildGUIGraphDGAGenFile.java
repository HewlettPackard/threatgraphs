...
public class VIS_BuildGUIGraphDGAGenFile {

	public String buildGUIGraphDGAGenFile(Vertica ver, String date, String hourParam, String minutesParam, boolean disconnect, String methodName, CommonMethods commonMethods, Properties graphProps) {
		...
		String fileName =newFile.getAbsolutePath() + "/webapps/gui/data/dgagen" + date.replace("/", "")  + "-"+ hourParam + minutesParam;
		...
		if (!new File(fileName).isFile()) {
			...
			try {
				...
				commonMethods.printMessage("QUERY", "*** METHOD buildGUIGraphDGAGenFile: " + query1);
