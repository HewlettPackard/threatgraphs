...
public class VIS_BuildHiveplotBL {

	public String buildHiveplotBL(Vertica ver, String date, String hourParam,
		...
		if (filterProps.get("minOutDegree") == null) {
			try {
				...
				filterProps.setProperty("minOutDegree", "0");
			}
		}
		...
		try {
			...
			commonMethods.printMessage("COMPUTATION_FLOW",
					"Generating hiveplot....");
			commonMethods.printMessage("QUERY", "*** METHOD buildHiveplotBL: "
					+ query1);
